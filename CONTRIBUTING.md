...
### Setup
```sh
$ git clone https://github.com/Sly777/React-UI-Debugger
$ cd React-UI-Debugger
$ npm install
```
...
to build React-UI-Debugger **once** or:

```sh
$ npm run watch
```

to have React-UI-Debugger build itself then incrementally build files on change.
